...
class ContentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'single_sharing_rent' => 'nullable|string',
            'double_sharing_rent' => 'required|string',
            'triple_sharing_rent' => 'nullable|string',
            'food_type' => 'required|in:None,Food Service,Tiffin Service',
            'food_inclusion' => 'required|in:Included,Excluded',
            'weekday_meals_price' => 'nullable|string',
            'weekend_meals_price' => 'nullable|string',
